      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-black">{stats?.total_projects || 0}</p>
              </div>
        ...
        <Card className="bg-white border border-gray-200 hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 font-medium">Insights Generated</p>
                <p className="text-3xl font-bold text-black">{stats?.total_insights || 0}</p>
              </div>
        ...
        <Card className="bg-white border border-gray-200 hover:shadow-md transition-shadow">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 font-medium">Personas Created</p>
                <p className="text-3xl font-bold text-black">{stats?.total_personas || 0}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-black">{stats?.total_api_queries || 0}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Start by creating your first project to discover audience insights and generate AI-powered content strategies using Qloo's cultural intelligence.
            </p>
            <Link to="/projects">
